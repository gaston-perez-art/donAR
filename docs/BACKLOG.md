...
- ⬜ **3.3 DECIDIDO (29 jul), por implementar.** Auto-confirmación con ventana de disputa (patrón world-class: Mercado Libre / AliExpress buyer protection). El aporte entra `pending` al subir el comprobante y arranca un reloj de **48 hs corridas**. El beneficiado puede confirmar o rechazar en cualquier momento; si no hace nada, a las 48 hs **se auto-confirma** → suma a meta y puntos igual que un confirmado explícito (no se penaliza al donante por la inacción del otro). **Countdown visible en ambos lados** (al beneficiado como presión suave, al donante como transparencia). El comprobante subido es la red de seguridad. Matiz: el principio pasa de "solo lo confirmado suma" a "confirmado explícito **o** auto-confirmado al vencer".
